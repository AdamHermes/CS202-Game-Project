...
//    Character player("../Assets/Character/Textures/character1.png","../Assets/Character/Textures/health.png");
//    Map gameMap;
...
//        //cout << player.attackRangeBox.left << " " << player.attackRangeBox.top << endl;
